...
const Home = () => {
    return (
        <div name='home' className='w-full bg-gradient-to-b from-black via-black to-gray-800' style={{ paddingTop: '80px' }}>
            <div className='max-w-screen-lg mx-auto flex flex-col-reverse items-center justify-center h-screen px-4 md:flex-row'>
                ...
                <div className='ml-6 mt-4 md:mt-0'>
                    <img src={HeroImage} alt='My Profile' className='mx-auto w-2/3 md:w-full max-h-80 md:max-h-full rounded-2xl' />
                </div>
            </div>
        </div>
    );
